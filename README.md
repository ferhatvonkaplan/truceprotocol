...
<p align="center">
  ...
  <a href="spec/v1.0/"><img src="https://img.shields.io/badge/spec-TATF_v1.0-8b5cf6.svg" alt="Spec Version"></a>
  ...
  <a href="benchmarks/"><img src="https://img.shields.io/badge/synthetic_benchmark-97%25-blue.svg" alt="Synthetic benchmark"></a>
  <a href="#validation"><img src="https://img.shields.io/badge/real--data-Pearson_0.69-8b5cf6.svg" alt="Real-data validation"></a>
</p>
...
Current version: **v1.0**. The v0.1 documents remain in [`spec/v0.1/`](spec/v0.1/) for reference.

| # | Document | Description |
|---|----------|-------------|
| 00 | [Introduction](spec/v1.0/00-introduction.md) | Motivation, scope, terminology, spec/implementer split |
| 01 | [Scoring Model](spec/v1.0/01-scoring-model.md) | Five-component ALPHA score; core vs aggregator profile |
| 02 | [Behavioral Baselines](spec/v1.0/02-behavioral-baselines.md) | EMA baselines, six scoring dimensions |
| 03 | [Anomaly Detection](spec/v1.0/03-anomaly-detection.md) | ATBF zones, routing, review queue |
| 04 | [Trust Attestation](spec/v1.0/04-trust-attestation.md) | Ed25519 signing, W3C VC mapping, signal provenance |
| 05 | [Adversarial Testing](spec/v1.0/05-adversarial-testing.md) | Resilience evaluation + signal-source integrity |
| 06 | [Market Stress](spec/v1.0/06-market-stress.md) | AVX indicator, k-anonymity |
| 07 | [Signal Aggregation](spec/v1.0/07-signal-aggregation.md) | External-signal contract, normalisation, fusion |
| 08 | [Regulatory Mapping](spec/v1.0/08-regulatory-mapping.md) | EU AI Act, NIST AI RMF, ISO/IEC 42001 crosswalk |

---

## Benchmarks

**Synthetic** benchmark — routing-accuracy on a generated dataset. Useful for
regression testing the scoring pipeline, *not* a real-world performance claim
(see [Validation](#validation) for that).

```
  1,000 synthetic agents  ·  97,370 transactions  ·  5 archetypes
  97% routing accuracy on synthetic data
...
Synthetic accuracy measures pipeline correctness, not predictive power. The
number that matters is how the model correlates with **real-world** trust
outcomes:

| Dataset | Metric | Result |
|---------|--------|--------|
| Bitcoin OTC Trust Network (real) | Pearson correlation | **0.69** |
| Synthetic fixtures | Pearson correlation | 0.95+ |

We report both, and we lead with 0.69 because it is the honest figure — the
synthetic 0.95+ reflects data generated by the same assumptions the model
encodes. To our knowledge this is the only agent-trust model validated against
a real trust network with the result published. A trust layer that hides its
own limits has already failed its own test.
